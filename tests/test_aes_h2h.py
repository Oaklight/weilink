...
from weilink._vendor.aes import aes_ecb_decrypt as py_decrypt
from weilink._vendor.aes import aes_ecb_encrypt as py_encrypt

try:
    from weilink._vendor.aes_openssl import aes_ecb_decrypt as ossl_decrypt
    from weilink._vendor.aes_openssl import aes_ecb_encrypt as ossl_encrypt
